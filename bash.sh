...
\e[17;${cl}H$ln\e[17;${cl}H$c2 Public ip: $green$line$ip4$re 
\e[18;${cl}H$ln\e[18;${cl}H$c2 $pink$(date +%A" $green"%B" $yellow"%D)$re$dim -- $bold$cyan$italic$(date +%T) 
\e[19;${cl}H$ln$re\n"
if [ "$SSH_CONNECTION" ]; then shsh=($SSH_CONNECTION);
printf "
\e[19;${cl}H$ln\e[19;${cl}H$c2 $bold"$red"ssh$re\
