...
################################
################ _colors
cl_black='\e[0;30m'; cl_red='\e[0;31m'; cl_green='\e[0;32m'; cl_yellow='\e[0;33m'; cl_blue='\e[0;34m'; cl_purple='\e[0;35m'; cl_cyan='\e[0;36m'; cl_white='\e[0;37m'; re='\e[0m'
...
PS1=''$re$blue$dim'$(date +%T)'$red' \u '$green'\H '$cyan'$PWD\e[2:$((RANDOM%5+1));$((RANDOM%15+1))m \$ '$re'\n'
